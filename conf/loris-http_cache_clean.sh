...
IMG_CACHE_ROOT_DIR="${buildout:directory}/var/images"
IMG_CACHE_DP_DIR="${buildout:directory}/var/cache/loris/img"
IMG_CACHE_LINKS_DIR="${buildout:directory}/var/cache/loris/links"
